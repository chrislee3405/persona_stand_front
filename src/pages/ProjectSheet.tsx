 ...
 * lock and scroll-reset-on-open all live there. This component supplies the
 * content: two columns inside a single scroll area -- a STICKY left column
 * with the write-up (overview / features / tech / links) and a scrolling
 * right column of feature-demo videos.
 *
